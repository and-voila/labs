...
const toolsDashboardItems: ToolsDashboardItemProps[] = [
  ...
  },
  {
    title: 'Write',
    icon: Icons.pen,
    linkHref: `${CP_PREFIX}/tools/write`,
  ...
  },
  {
    title: 'Optimize',
    icon: Icons.toolbox,
    linkHref: `${CP_PREFIX}/tools/optimize`,
  ...
  },
  {
    ...
    linkHref: `${CP_PREFIX}/tools/distribute`,
...
export function generateMetadata(): Metadata {
  ...
  const pageUrl = `${baseUrl}${CP_PREFIX}/tools`;
