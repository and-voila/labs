...
>(({ asChild, className, children, ...rest }, ref) => {
  const dividerClass = cn('mb-2 border-b pb-2', className);
...
export const PanelHeader = forwardRef<
  ...
  { asChild?: boolean } & React.HTMLAttributes<HTMLDivElement>
>(({ asChild, className, children, ...rest }, ref) => {
  const headerClass = cn('mb-2 border-b pb-2 text-sm', className);
...
>(({ asChild, className, children, ...rest }, ref) => {
  const headlineClass = cn(
    'mb-2 ml-1.5 py-2 text-xs font-medium text-foreground',
    className,
  );
...
export const PanelFooter = forwardRef<
  ...
  { asChild?: boolean } & React.HTMLAttributes<HTMLDivElement>
>(({ asChild, className, children, ...rest }, ref) => {
  const footerClass = cn('mt-2 border-t pt-2 text-sm', className);
